...
class AuthenticationService {
  ...
  Future<void> logOut({PushMessagingService? pushMessagingService}) async {
    ...
    if (userId != null) {
      ...
      await _userRepository.clearUserFcmToken(userId);

      await _userRepository.updateUserOnlineStatus(userId, false);
    }
